...
func (c *restClient) ListSecrets(ctx context.Context, req *secretmanagerpb.ListSecretsRequest, opts ...gax.CallOption) *SecretIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*secretmanagerpb.Secret, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			c.l.DebugContext(ctx, "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.ListSecrets", "request", clog.HTTPRequest(httpReq, nil))
			...
			c.l.DebugContext(ctx, "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.ListSecrets", "response", clog.HTTPResponse(httpRsp, buf))
...
func (c *restClient) CreateSecret(ctx context.Context, req *secretmanagerpb.CreateSecretRequest, opts ...gax.CallOption) (*secretmanagerpb.Secret, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		c.l.DebugContext(ctx, "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.CreateSecret", "request", clog.HTTPRequest(httpReq, jsonReq))
		httpRsp, err := c.httpClient.Do(httpReq)
		if err != nil {
			return err
		}
...
func (c *restClient) AddSecretVersion(ctx context.Context, req *secretmanagerpb.AddSecretVersionRequest, opts ...gax.CallOption) (*secretmanagerpb.SecretVersion, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		c.l.DebugContext(ctx, "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AddSecretVersion", "request", clog.HTTPRequest(httpReq, jsonReq))
		httpRsp, err := c.httpClient.Do(httpReq)
		if err != nil {
			return err
		}
		...
		c.l.DebugContext(ctx, "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AddSecretVersion", "response", clog.HTTPResponse(httpRsp, buf))
...
func (c *restClient) GetSecret(ctx context.Context, req *secretmanagerpb.GetSecretRequest, opts ...gax.CallOption) (*secretmanagerpb.Secret, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		c.l.DebugContext(ctx, "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.GetSecret", "request", clog.HTTPRequest(httpReq, nil))
		httpRsp, err := c.httpClient.Do(httpReq)
		if err != nil {
			return err
		}
		...
		c.l.DebugContext(ctx, "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.GetSecret", "response", clog.HTTPResponse(httpRsp, buf))
...
func (c *restClient) AccessSecretVersion(ctx context.Context, req *secretmanagerpb.AccessSecretVersionRequest, opts ...gax.CallOption) (*secretmanagerpb.AccessSecretVersionResponse, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		c.l.DebugContext(ctx, "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AccessSecretVersion", "request", clog.HTTPRequest(httpReq, nil))
		httpRsp, err := c.httpClient.Do(httpReq)
		if err != nil {
			return err
		}
		...
		c.l.DebugContext(ctx, "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AccessSecretVersion", "response", clog.HTTPResponse(httpRsp, buf))
