...
func (c *gRPCClient) ListSecrets(ctx context.Context, req *secretmanagerpb.ListSecretsRequest, opts ...gax.CallOption) *SecretIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*secretmanagerpb.Secret, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.ListSecrets", "request", cloggrpc.ProtoMessageRequest(ctx, req))
			resp, err = c.client.ListSecrets(ctx, req, settings.GRPC...)
			c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.ListSecrets", "request", cloggrpc.ProtoMessageResponse(resp))
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) CreateSecret(ctx context.Context, req *secretmanagerpb.CreateSecretRequest, opts ...gax.CallOption) (*secretmanagerpb.Secret, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.CreateSecret", "request", cloggrpc.ProtoMessageRequest(ctx, req))
		resp, err = c.client.CreateSecret(ctx, req, settings.GRPC...)
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.CreateSecret", "request", cloggrpc.ProtoMessageResponse(resp))
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) AddSecretVersion(ctx context.Context, req *secretmanagerpb.AddSecretVersionRequest, opts ...gax.CallOption) (*secretmanagerpb.SecretVersion, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AddSecretVersion", "request", cloggrpc.ProtoMessageRequest(ctx, req))
		resp, err = c.client.AddSecretVersion(ctx, req, settings.GRPC...)
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AddSecretVersion", "request", cloggrpc.ProtoMessageResponse(resp))
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) GetSecret(ctx context.Context, req *secretmanagerpb.GetSecretRequest, opts ...gax.CallOption) (*secretmanagerpb.Secret, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.GetSecret", "request", cloggrpc.ProtoMessageRequest(ctx, req))
		resp, err = c.client.GetSecret(ctx, req, settings.GRPC...)
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.GetSecret", "request", cloggrpc.ProtoMessageResponse(resp))
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) AccessSecretVersion(ctx context.Context, req *secretmanagerpb.AccessSecretVersionRequest, opts ...gax.CallOption) (*secretmanagerpb.AccessSecretVersionResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AccessSecretVersion", "request", cloggrpc.ProtoMessageRequest(ctx, req))
		resp, err = c.client.AccessSecretVersion(ctx, req, settings.GRPC...)
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AccessSecretVersion", "request", cloggrpc.ProtoMessageResponse(resp))
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *restClient) ListSecrets(ctx context.Context, req *secretmanagerpb.ListSecretsRequest, opts ...gax.CallOption) *SecretIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*secretmanagerpb.Secret, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.ListSecrets", "request", clog.HTTPRequest(httpReq, nil))
			...
			c.l.Log(ctx, clog.DynamicLevel(), "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.ListSecrets", "response", clog.HTTPResponse(httpRsp, buf))
...
func (c *restClient) CreateSecret(ctx context.Context, req *secretmanagerpb.CreateSecretRequest, opts ...gax.CallOption) (*secretmanagerpb.Secret, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.CreateSecret", "request", clog.HTTPRequest(httpReq, jsonReq))
		httpRsp, err := c.httpClient.Do(httpReq)
		if err != nil {
			return err
		}
		...
		c.l.Log(ctx, clog.DynamicLevel(), "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.CreateSecret", "response", clog.HTTPResponse(httpRsp, buf))
...
func (c *restClient) AddSecretVersion(ctx context.Context, req *secretmanagerpb.AddSecretVersionRequest, opts ...gax.CallOption) (*secretmanagerpb.SecretVersion, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AddSecretVersion", "request", clog.HTTPRequest(httpReq, jsonReq))
		httpRsp, err := c.httpClient.Do(httpReq)
		if err != nil {
			return err
		}
		...
		c.l.Log(ctx, clog.DynamicLevel(), "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AddSecretVersion", "response", clog.HTTPResponse(httpRsp, buf))
...
func (c *restClient) GetSecret(ctx context.Context, req *secretmanagerpb.GetSecretRequest, opts ...gax.CallOption) (*secretmanagerpb.Secret, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.GetSecret", "request", clog.HTTPRequest(httpReq, nil))
		httpRsp, err := c.httpClient.Do(httpReq)
		if err != nil {
			return err
		}
		...
		c.l.Log(ctx, clog.DynamicLevel(), "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.GetSecret", "response", clog.HTTPResponse(httpRsp, buf))
...
func (c *restClient) AccessSecretVersion(ctx context.Context, req *secretmanagerpb.AccessSecretVersionRequest, opts ...gax.CallOption) (*secretmanagerpb.AccessSecretVersionResponse, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		c.l.Log(ctx, clog.DynamicLevel(), "api request", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AccessSecretVersion", "request", clog.HTTPRequest(httpReq, nil))
		httpRsp, err := c.httpClient.Do(httpReq)
		if err != nil {
			return err
		}
		...
		c.l.Log(ctx, clog.DynamicLevel(), "api response", "serviceName", "secretmanager", "rpcName", "google.cloud.secretmanager.v1.SecretManagerService.AccessSecretVersion", "response", clog.HTTPResponse(httpRsp, buf))
